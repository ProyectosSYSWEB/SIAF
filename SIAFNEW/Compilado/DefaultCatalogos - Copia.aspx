<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DefaultCatalogos.aspx.cs" Inherits="SAF.DefaultCatalogos" %>
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="grdMenu" runat="server" AutoGenerateColumns="False" CssClass="table table-striped" Font-Size="Medium">
                            <Columns>
                                <asp:HyperLinkField DataNavigateUrlFields="Clave" DataTextField="Descripcion" HeaderText="CATÁLOGOS" />
                            </Columns>
