<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DefaultMovtos.aspx.cs" Inherits="SAF.DefaultMovtos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-6">
                <img src="images/pres6.png" class="auto-style3" />
            </div>
            <div class="col-md-3">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="grdMenu" runat="server" AutoGenerateColumns="False" CssClass="table table-striped" Font-Size="Medium">
                            <Columns>
                                <asp:HyperLinkField DataNavigateUrlFields="Clave" DataTextField="Descripcion" HeaderText="MOVIMIENTOS" />
                            </Columns>
