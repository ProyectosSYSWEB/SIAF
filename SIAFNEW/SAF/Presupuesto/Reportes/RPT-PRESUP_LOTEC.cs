...
namespace SAF.Presupuesto.Reportes {
    ...
    public class RPT_PRESUP_LOTEC : ReportClass {
        
        public RPT_PRESUP_LOTEC() {
        }
        
        public override string ResourceName {
            get {
                return "RPT-PRESUP_LOTEC.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SAF.Presupuesto.Reportes.RPT-PRESUP_LOTEC.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRPT_PRESUP_LOTEC : Component, ICachedReport {
        
        public CachedRPT_PRESUP_LOTEC() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RPT_PRESUP_LOTEC rpt = new RPT_PRESUP_LOTEC();
            rpt.Site = this.Site;
            return rpt;
        }
