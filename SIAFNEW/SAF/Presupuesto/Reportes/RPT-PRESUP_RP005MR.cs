...
namespace SAF.Presupuesto.Reportes {
    ...
    public class RPT_PRESUP_RP005MR : ReportClass {
        
        public RPT_PRESUP_RP005MR() {
        }
        
        public override string ResourceName {
            get {
                return "RPT-PRESUP_RP005MR.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SAF.Presupuesto.Reportes.RPT-PRESUP_RP005MR.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRPT_PRESUP_RP005MR : Component, ICachedReport {
        
        public CachedRPT_PRESUP_RP005MR() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RPT_PRESUP_RP005MR rpt = new RPT_PRESUP_RP005MR();
            rpt.Site = this.Site;
            return rpt;
        }
