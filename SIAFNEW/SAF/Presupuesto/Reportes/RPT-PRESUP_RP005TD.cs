...
namespace SAF.Presupuesto.Reportes {
    ...
    public class RPT_PRESUP_RP005TD : ReportClass {
        
        public RPT_PRESUP_RP005TD() {
        }
        
        public override string ResourceName {
            get {
                return "RPT-PRESUP_RP005TD.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SAF.Presupuesto.Reportes.RPT-PRESUP_RP005TD.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRPT_PRESUP_RP005TD : Component, ICachedReport {
        
        public CachedRPT_PRESUP_RP005TD() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RPT_PRESUP_RP005TD rpt = new RPT_PRESUP_RP005TD();
            rpt.Site = this.Site;
            return rpt;
        }
