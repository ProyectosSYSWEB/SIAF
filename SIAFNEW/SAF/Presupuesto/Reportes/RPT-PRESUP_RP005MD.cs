...
namespace SAF.Presupuesto.Reportes {
    ...
    public class RPT_PRESUP_RP005MD : ReportClass {
        
        public RPT_PRESUP_RP005MD() {
        }
        
        public override string ResourceName {
            get {
                return "RPT-PRESUP_RP005MD.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SAF.Presupuesto.Reportes.RPT-PRESUP_RP005MD.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRPT_PRESUP_RP005MD : Component, ICachedReport {
        
        public CachedRPT_PRESUP_RP005MD() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RPT_PRESUP_RP005MD rpt = new RPT_PRESUP_RP005MD();
            rpt.Site = this.Site;
            return rpt;
        }
