...
namespace SAF.Presupuesto.Reportes {
    ...
    public class RPT_PRESUP_RP030A : ReportClass {
        
        public RPT_PRESUP_RP030A() {
        }
        
        public override string ResourceName {
            get {
                return "RPT-PRESUP_RP030A.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SAF.Presupuesto.Reportes.RPT-PRESUP_RP030A.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRPT_PRESUP_RP030A : Component, ICachedReport {
        
        public CachedRPT_PRESUP_RP030A() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RPT_PRESUP_RP030A rpt = new RPT_PRESUP_RP030A();
            rpt.Site = this.Site;
            return rpt;
        }
