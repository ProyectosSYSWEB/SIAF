...
namespace SAF.Presupuesto.Reportes {
    ...
    public class RPT_PRESUP_RP008AD : ReportClass {
        
        public RPT_PRESUP_RP008AD() {
        }
        
        public override string ResourceName {
            get {
                return "RPT-PRESUP_RP008AD.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SAF.Presupuesto.Reportes.RPT-PRESUP_RP008AD.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRPT_PRESUP_RP008AD : Component, ICachedReport {
        
        public CachedRPT_PRESUP_RP008AD() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RPT_PRESUP_RP008AD rpt = new RPT_PRESUP_RP008AD();
            rpt.Site = this.Site;
            return rpt;
        }
