...
namespace SAF.Presupuesto.Reportes {
    ...
    public class RPT_Xejercer : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "SAF.Presupuesto.Reportes.RPT-Xejercer.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRPT_Xejercer : Component, ICachedReport {
        
        public CachedRPT_Xejercer() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RPT_Xejercer rpt = new RPT_Xejercer();
            rpt.Site = this.Site;
            return rpt;
        }
