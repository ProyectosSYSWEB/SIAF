...
namespace SAF.Presupuesto.Reportes {
    ...
    public class RPT_PRESUP_RP005AR : ReportClass {
        
        public RPT_PRESUP_RP005AR() {
        }
        
        public override string ResourceName {
            get {
                return "RPT-PRESUP_RP005AR.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SAF.Presupuesto.Reportes.RPT-PRESUP_RP005AR.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRPT_PRESUP_RP005AR : Component, ICachedReport {
        
        public CachedRPT_PRESUP_RP005AR() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RPT_PRESUP_RP005AR rpt = new RPT_PRESUP_RP005AR();
            rpt.Site = this.Site;
            return rpt;
        }
