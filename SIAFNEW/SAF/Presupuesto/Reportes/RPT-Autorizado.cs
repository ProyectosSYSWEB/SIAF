...
namespace SAF.Presupuesto.Reportes {
    ...
    public class RPT_Autorizado : ReportClass {
        
        public RPT_Autorizado() {
        }
        
        public override string ResourceName {
            get {
                return "RPT-Autorizado.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SAF.Presupuesto.Reportes.RPT-Autorizado.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRPT_Autorizado : Component, ICachedReport {
        
        public CachedRPT_Autorizado() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RPT_Autorizado rpt = new RPT_Autorizado();
            rpt.Site = this.Site;
            return rpt;
        }
