...
namespace SAF.Presupuesto.Reportes {
    ...
    public class RPT_PRESUP_RP005TR : ReportClass {
        
        public RPT_PRESUP_RP005TR() {
        }
        
        public override string ResourceName {
            get {
                return "RPT-PRESUP_RP005TR.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SAF.Presupuesto.Reportes.RPT-PRESUP_RP005TR.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRPT_PRESUP_RP005TR : Component, ICachedReport {
        
        public CachedRPT_PRESUP_RP005TR() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RPT_PRESUP_RP005TR rpt = new RPT_PRESUP_RP005TR();
            rpt.Site = this.Site;
            return rpt;
        }
