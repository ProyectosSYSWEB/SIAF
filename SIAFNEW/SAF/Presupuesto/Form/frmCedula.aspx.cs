    ...
    public partial class frmCedula : System.Web.UI.Page
    {
        ...
        private void guarda_encabezado(ref string VerificadorInserta, ref string Folio)
        {
            try
            {
                ...
                string NumPoliza = lblMesPol.Text + lblLiteralPol.Text + txtPoliza.Text.ToUpper();
                objDocumento.PolizaComprometida = NumPoliza;
                objDocumento.PolizaDevengado = NumPoliza;
                objDocumento.PolizaEjercido = NumPoliza;
                objDocumento.PolizaPagado = NumPoliza;
        ...
        protected void grdDocumentos_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (Verificador == "0")
                {
                    ...
                    txtPoliza.Text = objDocumento.PolizaComprometida.Substring(3, 5);
        ...
        protected void btnNuevo_Click(object sender, ImageClickEventArgs e)
        {
            ...
            TabContainer1.ActiveTabIndex = 0;
            Session["DocDet"] = null;
            bool CargarAdicional = true;
            Session["CargarAdicional"] = CargarAdicional;//false;
            ...
            //lblPrefijoPoliza.Text = txtfechaDocumento.Text.Substring(3, 2) + LiteralCedula;
        ...
        protected void LinkGenerarPolizaPrevia_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Verificador != "1")
                {
                    ...
                    Session["DocDet"] = generarPolizaPrevia;
                    string urlReporte = string.Empty;
                    urlReporte = "https://sysweb.unach.mx/SIAF-Contabilidad/Contabilidad/Reportes/VisualizadorCrystal.aspx?Tipo=RP-005_P&Ejercicio=2021&id=" + IdPoliza;
                    string _open = "window.open('" + urlReporte + "', '_newtab');";
                    ScriptManager.RegisterStartupScript(this, this.GetType(), Guid.NewGuid().ToString(), _open, true);
                }
                else if (Verificador == "1")
        ...
        protected void LinkGenerarPoliza_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                grdDocumentos.SelectedIndex = row.RowIndex;
                objDocumento.Id = Convert.ToInt32(grdDocumentos.SelectedRow.Cells[0].Text);
                Detalle.Id_Documento = Convert.ToInt32(grdDocumentos.SelectedRow.Cells[0].Text); ;
                string claveEvento = Convert.ToString(grdDocumentos.SelectedRow.Cells[10].Text);
