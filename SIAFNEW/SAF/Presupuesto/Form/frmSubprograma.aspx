<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmSubprograma.aspx.cs" Inherits="SAF.Presupuesto.Form.frmSubprograma" %>
                                                        ...
                                                        <tr>
                                                            <td class="auto-style1">
                                                                <table style="width: 100%;">
                                                                    ...
                                                                    <tr>
                                                                        <td style="width: 30%">
                                                                            <asp:Label ID="Label1" runat="server" Text="Nivel académico"></asp:Label>
                                                                        </td>
                                                                        <td>
                                                                            <asp:DropDownList ID="DDLNvlacd2" runat="server" Width="500px" AutoPostBack="True"></asp:DropDownList>
                                                                        </td>
                                                                    </tr>
