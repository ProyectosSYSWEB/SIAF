<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Acceso.aspx.cs" Inherits="Ejemplo.Acceso" %>
...
<body>
    ...
    <header>
        ...
        <div class="encabezado">
                ...
                <a href="https://sysweb.unach.mx/"><asp:Image ID="Image1" ImageUrl="https://sysweb.unach.mx/resources/imagenes/logo_sysweb_b.png" runat="server"/></a>
            </div>

                                </td>
                                <td  style="width:50%" class="centro">
                                    <asp:Label ID="Label2" runat="server" Text="Sistema de Programaciòn y Presupuesto" CssClass="titulo_sistema"></asp:Label><br />
                                    <asp:Label ID="Label3" runat="server" Text="SYSPP" CssClass="subtitulo_sistema"></asp:Label>
                                </td>
                                <td>
                                     <div class="cuadro_sistemas">
                                         <asp:Label ID="lblSistemas" runat="server" Text="Cambiar de sistema:" ></asp:Label><br />
                                         <asp:DropDownList ID="ddlSistemas" runat="server" CssClass="f11px"  Width="140px" OnSelectedIndexChanged="ddlSistemas_SelectedIndexChanged">
                                         </asp:DropDownList>
                                            <asp:Button ID="btnIr" runat="server" Text="Ir" CssClass="btn4" OnClick="btnIr_Click" />
                                     </div>
              ...
              <div class="c_info">
                        ...
                        <div class="contenido">
                            ...
                            <div class="cuadro_login centro">
                                ...
                                <asp:Label ID="Label1" runat="server" Text="Iniciar Sesión Lisseth s" CssClass="gris_20px"> </asp:Label>
                                <br/><br/>
                                ...
                                <br /><br />
                                  ...
                                  <div class="gris_12px">
                                      <a href="https://sysweb.unach.mx/administrator">Mi cuenta Sysweb</a><br /><br />
                                  ...
                                  <a href="https://sysweb.unach.mx/resources/help.aspx">¿Necesitas ayuda?</a>
                                    <br /><br />
                                      ...
                                      <div class="mensaje"> <div class="mensaje">
                                  ...
                                  <img src="https://sysweb.unach.mx/resources/imagenes/log_sistemas.png"/>
...
-- 
       ...
       <footer>
     <img src="https://sysweb.unach.mx/resources/imagenes/imgfooter.png" style="min-width:900px; height:auto"; />           
       </footer>
