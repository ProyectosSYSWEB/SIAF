...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5">
                <div id="divEspecificaciones" runat="server">
                    <div class="card text-white bg-info   mb-3" style="max-width: 20rem;">
                        <div class="card-header">
                            <asp:Label ID="lblEncEspecificaciones" runat="server" Text=""></asp:Label>
                        </div>
                        <div class="card-body">
                            <div class="card-text text-white">
                                <asp:Label ID="lblEspecificaciones" runat="server" Text="Label"></asp:Label>
                            </div>
                        </div>
                    </div>
                </div>
